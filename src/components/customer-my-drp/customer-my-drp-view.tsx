...
import { ProfileDrpIcon } from '@/components/customer-profile/profile-product-icons';
...
function IconAlert() {
  return (
    <svg viewBox="0 0 24 24" className="h-5 w-5" fill="none" aria-hidden="true">
      ...
      <path d="M10.3 4.2 2.6 18a2 2 0 0 0 1.7 3h15.4a2 2 0 0 0 1.7-3L13.7 4.2a2 2 0 0 0-3.4 0Z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
    </svg>
  );
}
...
export type CustomerMyDrpViewProps = {
  t: TranslateFn;
};

export function CustomerMyDrpView({ t }: CustomerMyDrpViewProps) {
  return (
        ...
        >
          <div className="relative h-48 w-48 xl:h-56 xl:w-56">
            ...
            <span className="relative inline-flex text-[#3b82f6]">
              <ProfileDrpIcon className="h-24 w-24 xl:h-28 xl:w-28" />
            </span>
          </div>
        </div>
        <div className="relative w-full px-5 pt-8 sm:px-6 sm:pt-10 lg:px-8 xl:px-10">
          ...
          <div className="relative z-10 mt-8 mb-[-2.75rem] grid w-full gap-3 sm:mb-[-3.25rem] sm:grid-cols-2 xl:grid-cols-4">
            ...
            <SummaryStatCard
              ...
              value={EMPTY_STATS.services}
              hint={t('stats.servicesHint')}
            />
            <SummaryStatCard
              icon={<IconBranch />}
              label={t('stats.scenarios')}
              value={EMPTY_STATS.scenarios}
              hint={t('stats.scenariosHint')}
            />
            <SummaryStatCard
              icon={<IconAlert />}
            ...
            <div className={`${cardClass} px-6 py-12 sm:px-10 sm:py-14`}>
              <div className="mx-auto flex max-w-lg flex-col items-center text-center">
                <span className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-[#eff6ff] text-[#0066ff]">
                  <ProfileDrpIcon className="h-8 w-8" />
                </span>
          ...
          <aside className="min-w-0 space-y-4 xl:sticky xl:top-4 xl:self-start">
            <div className={`${cardClass} p-5 sm:p-6`}>
              ...
              <ol className="mt-4 space-y-1">
                ...
                <WorkflowStep icon={<IconListCheck />} title={t('workflow.step5')} description={t('workflow.step5Desc')} />
                <WorkflowStep
                  icon={<IconValidate />}
