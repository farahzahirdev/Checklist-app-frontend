...
export default function AdminPreviewLayout({ children }: { children: ReactNode }) {
  ...
  const navItems = [
    { href: '/admin-preview', label: 'Dashboard', icon: 'home' },
    { href: '/admin-preview/assessments', label: 'Assessments', icon: 'clipboard' },
    { href: '/admin-preview/reports', label: 'Reports', icon: 'report' },
    { href: '/admin-preview/checklist-content', label: 'Checklist Content', icon: 'checklist' },
    { href: '/admin-preview/products', label: 'Products', icon: 'box' },
    { href: '/admin-preview/users', label: 'Users', icon: 'users' },
    { href: '/admin-preview/audit-logs', label: 'Audit Logs', icon: 'shield' },
    { href: '/admin-preview/settings', label: 'Settings', icon: 'settings' },
    ...
    <main className="h-screen bg-[#e9eef8]">
      <section className="relative h-full w-full overflow-hidden border border-[#263f6e] bg-[#f4f6fb] text-[#182843]">
        ...
        <div className="grid h-full min-h-0 lg:grid-cols-[250px_1fr]">
          ...
          >
            <Link href="/admin-preview" className="flex items-center gap-2 border-b border-[#1f3f73] pb-4">
